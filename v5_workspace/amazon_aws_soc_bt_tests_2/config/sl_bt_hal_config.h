...
#define SL_BT_HAL_DEFAULT_IO_CAPABILITIES sl_bt_sm_io_capability_displayyesno
...
// <i> Default: 0
#define SL_BT_HAL_DEFAULT_SECURITY_CONFIG_BONDING_REQUIRES_MITM_PROTECTION	        1
...
// <i> Default: 1
#define SL_BT_HAL_DEFAULT_SECURITY_CONFIG_BONDING_REQUESTS_NEED_TO_BE_CONFIRMED     0
